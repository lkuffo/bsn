...
void Logger::body() {
    ...
    ros::Subscriber voltage_status_sub = n.subscribe("log_voltage_status", 1000, &Logger::receiveVoltageStatus, this);
...
void Logger::receiveVoltageStatus(const archlib::VoltageStatus::ConstPtr& msg) {
